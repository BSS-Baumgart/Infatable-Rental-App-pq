...
import { ArrowLeft, Calendar, Edit, FileText, Package, Phone, User, Mail, MapPin } from "lucide-react"
                    ...
                    <div className="space-y-4">
                      {reservation.attractions.map((item) => (
                        <div
                          ...
                          onClick={() => router.push(`/attractions/${item.attractionId}`)}
                        >
                          <div className="flex items-center gap-4">
                            ...
                            <div>
                              <div className="font-medium">{item.attraction.name}</div>
                              <div className="text-sm text-gray-500 dark:text-gray-400">
                                {item.attraction.width}cm × {item.attraction.length}cm × {item.attraction.height}cm
                              </div>
                            </div>
                          </div>
